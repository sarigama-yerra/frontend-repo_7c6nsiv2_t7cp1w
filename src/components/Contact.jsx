      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="rounded-2xl border border-black/10 bg-white p-8 md:p-10 shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a href="mailto:lokesh@example.com" className="inline-flex items-center gap-2 rounded-md bg-black text-white px-5 py-3 text-sm font-medium hover:bg-gray-900">
